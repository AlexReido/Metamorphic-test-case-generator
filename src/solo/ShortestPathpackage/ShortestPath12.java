...
public class ShortestPath12 {
	...
	private void CalculateMinimumDistance(Node evaluationNode, Integer edgeWeigh, Node sourceNode) {
	    ...
	    if (sourceDistance - edgeWeigh < evaluationNode.getDistance()) { /* changed 'sourceDistance + edgeWeigh' to 'sourceDistance - edgeWeigh' - mutation 12 */
	...
	public static void main(String[] args) {//"ObjectFiles/graph.ser";
        ...
        try {
        	...
        	ShortestPath12 sp = new ShortestPath12();
