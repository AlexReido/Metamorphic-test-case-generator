...
public class ShortestPath15 {
	
	public ShortestPath15() {}
	/*
	 * Change this!
	 */
	...
	private void CalculateMinimumDistance(Node evaluationNode, Integer edgeWeigh, Node sourceNode) {
	    ...
	    if (sourceDistance + edgeWeigh < (evaluationNode.getDistance()-1)) { /* changed evaluationNode.getDistance() to evaluationNode.getDistance()-1 - mutation 15 */
	...
	public static void main(String[] args) {//"ObjectFiles/graph.ser";
        ...
        try {
        	...
        	ShortestPath15 sp = new ShortestPath15();
