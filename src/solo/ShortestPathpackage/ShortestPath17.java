...
public class ShortestPath17 {
	
	public ShortestPath17() {}
	/*
	 * Change this!
	 */
	...
	private void CalculateMinimumDistance(Node evaluationNode, Integer edgeWeigh, Node sourceNode) {
	    ...
	    if (sourceDistance + edgeWeigh < evaluationNode.getDistance()) { 
	        evaluationNode.setDistance(sourceDistance - edgeWeigh);  /* changed sourceDistance + edgeWeigh to sourceDistance - edgeWeigh - mutation 17 */
	...
	public static void main(String[] args) {//"ObjectFiles/graph.ser";
        ...
        try {
        	...
        	ShortestPath17 sp = new ShortestPath17();
