...
public class ShortestPath16 {
	
	public ShortestPath16() {}
	/*
	 * Change this!
	 */
	...
	private void CalculateMinimumDistance(Node evaluationNode, Integer edgeWeigh, Node sourceNode) {
	    ...
	    if (sourceDistance + edgeWeigh < (evaluationNode.getDistance()+1)) { /* changed evaluationNode.getDistance() to evaluationNode.getDistance()+1 - mutation 16 */
	...
	public static void main(String[] args) {//"ObjectFiles/graph.ser";
        ...
        try {
        	...
        	ShortestPath16 sp = new ShortestPath16();
