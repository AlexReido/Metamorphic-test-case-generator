...
public class ShortestPath14 {
	
	public ShortestPath14() {}
	/*
	 * Change this!
	 */
	...
	private void CalculateMinimumDistance(Node evaluationNode, Integer edgeWeigh, Node sourceNode) {
	    ...
	    if (sourceDistance + edgeWeigh == evaluationNode.getDistance()) { /* changed < to = - mutation 14 */
	...
	public static void main(String[] args) {//"ObjectFiles/graph.ser";
        ...
        try {
        	...
        	ShortestPath14 sp = new ShortestPath14();
